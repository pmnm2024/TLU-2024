...
@InputType()
class DistrictUpdateManyWithoutAdministrativeUnitsInput {
...
export { DistrictUpdateManyWithoutAdministrativeUnitsInput as DistrictUpdateManyWithoutAdministrativeUnitsInput };
