...
@InputType()
class DistrictCreateNestedManyWithoutProvincesInput {
...
export { DistrictCreateNestedManyWithoutProvincesInput as DistrictCreateNestedManyWithoutProvincesInput };
