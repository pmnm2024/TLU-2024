...
@InputType()
class SupportRequestCreateNestedManyWithoutSupportRequestDetailsInput {
...
export { SupportRequestCreateNestedManyWithoutSupportRequestDetailsInput as SupportRequestCreateNestedManyWithoutSupportRequestDetailsInput };
