...
@InputType()
class SupportRequestCreateNestedManyWithoutSupportRequestTypesInput {
...
export { SupportRequestCreateNestedManyWithoutSupportRequestTypesInput as SupportRequestCreateNestedManyWithoutSupportRequestTypesInput };
