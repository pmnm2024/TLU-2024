...
const warehouse_controller_base_1 = require("./base/warehouse.controller.base");
let WarehouseController = class WarehouseController extends warehouse_controller_base_1.WarehouseControllerBase {
    service;
    constructor(service) {
        super(service);
